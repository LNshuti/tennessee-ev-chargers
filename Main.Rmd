...
alt_fuel_stations_davidson <- 
  ...
  select(unique_stations, latitude, longitude,street_address, city, zip) %>%
  unique()
```
...
davidson_chargers_leaflet <- 
  leaflet(davidson.metro) %>% 
    addTiles() %>% 
    addCircleMarkers(
        data = alt_fuel_stations_davidson, lat = ~latitude, lng = ~longitude, 
        popup = paste("Name", alt_fuel_stations_davidson$unique_stations, "<br>",
                      "Addr:", alt_fuel_stations_davidson$street_address, "<br>",
                      "City:", alt_fuel_stations_davidson$city, "<br>",
                      "Zip:", alt_fuel_stations_davidson$zip)
